...
void Plot_cross_section_EICRecon_eP(const int plot_RC_flag = 1, const int plot_ACC_flag = 1, TString inFileName = "Input", const int energy_flag = 9130)
{
  ...
  {
    //9x130 GeV
    sigma_BeAGLE = 3.645e-4; //mb (eN)
    sigma_BeAGLE_fb = 3.645e8; //fb (eN)
  ...
  {
    //10x130 GeV
    sigma_BeAGLE = 3.707e-4; //mb (eN)
    sigma_BeAGLE_fb = 3.707e8; //fb (eN)
