...
void analyze_eD_DIS_eicrecon_RC_eP(TString fileList = "./fileLists/26.03.1/fileList_eD_10x130_DIS_eP_short.list", TString outputName = "./output/test_output_RC_eP")
{
  ...
  for(unsigned int x_bin = 0; x_bin < nx_bins; x_bin++)
  {
    ...
    //reco ZDC neutral perticles
		TTreeReaderArray<float> reco_ZDC_px = {tree_reader, "ReconstructedFarForwardZDCNeutrals.momentum.x"};
  	TTreeReaderArray<float> reco_ZDC_py = {tree_reader, "ReconstructedFarForwardZDCNeutrals.momentum.y"};
  	TTreeReaderArray<float> reco_ZDC_pz = {tree_reader, "ReconstructedFarForwardZDCNeutrals.momentum.z"};
  	TTreeReaderArray<float> reco_ZDC_E = {tree_reader, "ReconstructedFarForwardZDCNeutrals.energy"};

  	TTreeReaderArray<float> reco_ZDC_x = {tree_reader, "ReconstructedFarForwardZDCNeutrals.referencePoint.x"};
  	TTreeReaderArray<float> reco_ZDC_y = {tree_reader, "ReconstructedFarForwardZDCNeutrals.referencePoint.y"};
  	TTreeReaderArray<float> reco_ZDC_z = {tree_reader, "ReconstructedFarForwardZDCNeutrals.referencePoint.z"};
